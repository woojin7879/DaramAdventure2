...
test('prologue replays for every fresh first year, even if previously seen, but not checkpoints or later years',()=>{
 ...
 assert.equal(shouldPlayPrologue({year:1,checkpoint:null,seen:true}),true);
